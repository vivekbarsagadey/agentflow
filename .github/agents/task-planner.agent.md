...
handoffs:
  - label: Start Implementation
    ...
    prompt: Begin implementing the plan. Start with Phase 1 tasks and follow the implementation details document using AgentFlow FastAPI/LangGraph best practices.
    send: false
